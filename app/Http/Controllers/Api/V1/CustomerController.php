...
class CustomerController extends Controller
{
    ...
    public function update_profile(Request $request)
    {
        ...
        if($request->button_type != 'change_password' && !$request->otp ){
            ...
            } elseif ( data_get($login_settings, 'email_verification_status') == 1 && $request->email && ($user->email != $request->email || $request->button_type == 'email' || !$user->is_email_verified && !$request->button_type )) {
