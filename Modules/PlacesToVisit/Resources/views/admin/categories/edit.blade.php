...
<div class="content container-fluid">
        ...
        <div class="row align-items-center">
            <div class="col-sm mb-2 mb-sm-0">
                <h1 class="page-header-title">
                    <i class="tio-edit"></i> {{ translate('messages.edit_place_category') }}
                </h1>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('admin.places.categories.update', $category->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
