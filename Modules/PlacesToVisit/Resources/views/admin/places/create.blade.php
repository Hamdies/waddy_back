                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="latitude" id="latitude" class="form-control" 
                                           placeholder="e.g. 30.0444" required readonly>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" name="longitude" id="longitude" class="form-control" 
                                           placeholder="e.g. 31.2357" required readonly>
                                </div>
                                <div class="form-group">
                                    <label class="input-label">{{ translate('messages.address') }}</label>
                                    <textarea name="address" id="address" class="form-control" rows="3"
                                              placeholder="{{ translate('messages.enter_address') }}"></textarea>
                                </div>
                            </div>
                            <div class="col-lg-8">
...
<script>
    ...
    function initMap() {
        // Default to Cairo, Egypt as center
        const initialPosition = { lat: 30.0444, lng: 31.2357 };
        ...
        // Add marker (initially hidden until user clicks)
        marker = new google.maps.Marker({
            position: initialPosition,
            map: map,
            draggable: true,
            animation: google.maps.Animation.DROP,
            title: "{{ translate('messages.place_location') }}",
            visible: false
        });
        
        // Info window
        infoWindow = new google.maps.InfoWindow({
            content: "{{ translate('messages.click_map_to_select_location') }}"
        });
