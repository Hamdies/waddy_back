...
<head>
    ...
    <!-- Title -->
    <title>{{translate('messages.error')}} 404 | {{\App\Models\BusinessSetting::where(['key'=>'business_name'])->first()->value??'Waddy'}}</title>
...
<div class="footer text-center">
    <ul class="list-inline list-separator">
        <li class="list-inline-item">
            <a class="list-separator-link" target="_blank" href="{{route('contact-us')}}">{{\App\Models\BusinessSetting::where(['key'=>'business_name'])->first()->value??'Waddy'}} {{translate('messages.support')}}</a>
        </li>
    </ul>
</div>
<!-- End Footer -->
